...
<div>
  <h2>Contact</h2>
  Contact information for a person, e.g., social media links.<br/>
  <dl>
    <dt><b>id</b></dt><dd><i>Unique ID for Contact info.</i></dd></dt>
    <dt><b>person_id</b></dt><dd><i>ID for the Contact's person.</i></dd></dt>
    <dt><b>contact_type_id</b></dt><dd><i>Unique id for the kind of contact, e.g., facebook vs youtube etc.</i></dd></dt>
...
<div>
  <h2>ContactType</h2>
  Contact information type, e.g., facebook vs linktree etc.<br/>
  <dl>
    <dt><b>id</b></dt><dd><i>ID for the contact type</i></dd></dt>
    <dt><b>display_name</b></dt><dd><i>Human readable name of the contact type</i></dd></dt>
    <dt><b>rank</b></dt><dd><i>For ordering links by source. e.g., linktree before facebook, etc.</i></dd></dt>
    <dt><b>private</b></dt><dd><i>Whether the contact info should remain private</i></dd></dt>
  </dl>
</div>
<div>
  <h2>EventGen</h2>
  Recurring events, including event's venue and the recurrence pattern.  Due to the data design, even one-off gigs are defined in EventGen.<br/>
  <dl>
...
<div>
  <h2>EventOcc</h2>
  Specific events, including the event's specific date and EventGen that it derives from.<br/>
  <dl>
...
<div>
  <h2>Genre</h2>
  Coarse genre information. Genres are at the level of 'Jazz' vs 'Blues', etc.  See also `SubGrenre`.<br/>
  <dl>
...
<div>
  <h2>Key</h2>
  Key signature / mode information.<br/>
  <dl>
...
<div>
  <h2>LinkSource</h2>
  Information about the type of link<br/>
  <dl>
    <dt><b>id</b></dt><dd><i>Unique ID of the link type</i></dd></dt>
    <dt><b>rank</b></dt><dd><i>For ordering links by source. e.g., web links before images, etc.</i></dd></dt>
  </dl>
</div>
<div>
  <h2>Mode</h2>
  Information about mode.<br/>
  <dl>
...
<div>
  ...
  Video link for a performed song.<br/>
  <dl>
    <dt><b>id</b></dt><dd><i>Unique ID of the PerformanceVideo</i></dd></dt>
    <dt><b>song_perform_id</b></dt><dd><i>ID of the SongPerform</i></dd></dt>
    <dt><b>source_id</b></dt><dd><i>Unique ID of the recording's source, e.g., youtube or spotify, etc.</i></dd></dt>
    <dt><b>link</b></dt><dd><i>Link, etc., url or uri</i></dd></dt>
    <dt><b>display_name</b></dt><dd><i>Human readable name of link</i></dd></dt>
  </dl>
</div>
<div>
  <h2>Person</h2>
  Public Information about a person.<br/>
  <dl>
...
<div>
  <h2>PersonPicture</h2>
  Links to person pictures.<br/>
  <dl>
    <dt><b>id</b></dt><dd><i>Unique ID for PersonPicture.</i></dd></dt>
    <dt><b>person_id</b></dt><dd><i>ID for picture's person.</i></dd></dt>
    <dt><b>source_id</b></dt><dd><i>Unique ID of photo's source, e.g, jpg vs png etc.</i></dd></dt>
    <dt><b>link</b></dt><dd><i>Link to picture.</i></dd></dt>
  </dl>
</div>
<div>
  <h2>PersonInstrument</h2>
  Which instruments are played by a given person.<br/>
  <dl>
...
<div>
  <h2>RefRec</h2>
  Links to reference recordings of songs.<br/>
  <dl>
    <dt><b>id</b></dt><dd><i>Unique ID of the RefRec.</i></dd></dt>
    <dt><b>song_id</b></dt><dd><i>ID of the RefRec's song</i></dd></dt>
    <dt><b>source_id</b></dt><dd><i>Unique ID of the recording's source type, e.g., YouTube or Spotify, etc.</i></dd></dt>
    <dt><b>link</b></dt><dd><i>Link, etc., url or uri</i></dd></dt>
    <dt><b>display_name</b></dt><dd><i>Human readable name of link</i></dd></dt>
  </dl>
</div>
...
<div>
  <h2>SetlistSong</h2>
  Information about songs on a Setlist, including song name, key, and which instrument I will play.<br/>
  <dl>
...
<div>
  <h2>Song</h2>
  Information about a song, including song name, key, etc.<br/>
  <dl>
...
<div>
  <h2>SongLearn</h2>
  Information about songs that I've learned, including instrument, key, and when I learned it.<br/>
  <dl>
